<template>
  <div class="building-edit-page">
    <div class="page-header">
      <h1 class="page-title">
        <TranslatedText>Edit Building</TranslatedText>
      </h1>
      <p class="page-subtitle">
        <TranslatedText>Update building information</TranslatedText>
      </p>
    </div>

    <div class="edit-container" v-if="!pageLoading">
      <n-card>
        <n-form
          ref="formRef"
          :model="buildingData"
          ...
          <div class="form-actions">
            <n-space>
              ...
              <n-button 
                ...
                @click="handleSubmit"
              >
                <TranslatedText>Update Building</TranslatedText>
              </n-button>
            </n-space>
          </div>
        </n-form>
...
export default {
  ...
  setup() {
    ...
    // 初始化
    onMounted(async () => {
      await Promise.all([loadBuilding(), loadAreas(), loadAmenities()])
    })
